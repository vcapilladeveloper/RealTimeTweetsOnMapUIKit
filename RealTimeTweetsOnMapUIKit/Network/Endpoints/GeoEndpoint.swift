...
struct GeoEndpoint: Endpoint {
    ...
    init(_ placeId: String) {
        self.init(baseURLString: ConfigUtils.getConfiguration(with: "BASE_URL") ?? "", path: "/1.1/geo/id/\(placeId).json", method: .get, paramEncoding: .JSONEncoding, showDebugInfo: true)
